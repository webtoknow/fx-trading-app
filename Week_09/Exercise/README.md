...
## Exercise I - Importing initial project setup in IDE
...
## Exercise III - Implement REST endpoint for displaying list of all trades
...
## Exercise IV - Implement remote REST endpoint caller
...
```
## Exercise V - Implement functionality for saving trades
...
## Exercise VI - Secure the API with authorization filter
