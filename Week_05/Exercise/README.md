...
For *toastr*, we need an another css file. So, in *Week_05/Exercise/Code/ui/src*, let's create a new file, *toast.css*:
...
In order to load *toast* style, we should also update *angular.json*:
...
We should also update *app.module.ts*:
