...
class WebDriverManager {
    ...
    WebDriver createWebDriver() {
        ...
        switch (_browser) {
            ...
            case MOZILLA:
                ...
                Tacitus.getInstance().logSuccess("Created a new Mozilla Firefox instance");
    ...
    private BrowserTypes getDefaultBrowser() {
        ...
        switch (_browser) {
            ...
            case "MOZILLA":
                Tacitus.getInstance().log("Current default browser is Mozilla Firefox");
                return BrowserTypes.MOZILLA;
            default:
    ...
    private enum BrowserTypes {
        ...
        IE("IEDriverServer.exe"); //NOT PRESENT FOR AN OBVIOUS REASON, present as to talk about some complications which are needed sometimes
