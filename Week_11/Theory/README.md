...
**Course agenda**
   1. Why Implement Automated testing?
   2. What should we automate?
   3. Challenges using automated testing
   4. Tools and integrations
   5. Example of a most basic UI testing Script
   6. Framework dive in (Presented in the Exercise section)
...
**3. Challenges when working with automated testing**
...
* Creating an automation framework requires usage of any tools, libraries and integrations with various other systems
   ...
   **5. Example of a most Basic UI Test**
